...
/***/ function(module, exports, __webpack_require__) {
	...
	var productEvents = __webpack_require__(9);
	var orderEvents = __webpack_require__(35);
	var profileEvents = __webpack_require__(38);
	var cartEvents = __webpack_require__(41);
	var stripeEvents = __webpack_require__(42);
	var adminEvents = __webpack_require__(45);
...
/***/ function(module, exports) {
	...
	var app = {
	  host: 'https://brewtiq-api.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var productApi = __webpack_require__(10);
	var productUi = __webpack_require__(11);
	var cartStorage = __webpack_require__(33);
	...
	var onShowProduct = function onShowProduct(event) {
	  ...
	  productApi.showProduct(id).done(productUi.showSuccess);
	};

	var onGetProducts = function onGetProducts() {
	  // console.log("this is the document ready function");
	  productApi.indexProducts().done(productUi.getProductsSuccess);
	};
	...
	var onWine = function onWine(event) {
	  event.preventDefault();
	  $('#wine-button').css('border', '2px solid white');
	  $('#beer-button').css('border', 'none');
	  $('#cider-button').css('border', 'none');
	  $('#all-button').css('border', 'none');
	  productApi.getWine().done(productUi.getProductsSuccess);
	};

	var onBeer = function onBeer(event) {
	  event.preventDefault();
	  $('#wine-button').css('border', 'none');
	  $('#beer-button').css('border', '2px solid white');
	  $('#cider-button').css('border', 'none');
	  $('#all-button').css('border', 'none');
	  productApi.getBeer().done(productUi.getProductsSuccess);
	};

	var onCider = function onCider(event) {
	  event.preventDefault();
	  $('#wine-button').css('border', 'none');
	  $('#beer-button').css('border', 'none');
	  $('#cider-button').css('border', '2px solid white');
	  $('#all-button').css('border', 'none');
	  productApi.getCider().done(productUi.getProductsSuccess);
	};

	var onAll = function onAll(event) {
	  event.preventDefault();
	  $('#wine-button').css('border', 'none');
	  $('#beer-button').css('border', 'none');
	  $('#cider-button').css('border', 'none');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getCider = function getCider() {
	  return $.ajax({
	    url: app.host + '/cider',
	    method: 'GET'
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showSuccess = function showSuccess(data) {
	  var productTemplate = __webpack_require__(12);
	...
	var getProductsSuccess = function getProductsSuccess(products) {
	  ...
	  $('#products').html('');
	  var displayAllProducts = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"single-product\">\n  <img src="
	    ...
	    + " <p>\n  <form id=\"form\">\n    <fieldset>\n      <p>Quantity: <input type=\"number\" min=\"1\" placeholder=\"1\"></p>\n      <input type=\"text\" style=\"display: none\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1.name : stack1), depth0))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"col-md-4 img\" data-toggle=\"modal\" data-target=\"#item\" height=\"260px\">\n      <!-- <img src="
	  ...
	  return "\n    <div class=\"col-md-4 img\" data-toggle=\"modal\" data-target=\"#item\">\n      <img src="
	    + alias4(((helper = (helper = helpers.image || (depth0 != null ? depth0.image : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"image","hash":{},"data":data}) : helper)))
	    + " id="
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "  width=\"80\">\n      <h5> "
...
/***/ function(module, exports, __webpack_require__) {
	...
	var populateCart = function populateCart(data) {
	  var cartTemplate = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetOrderHistory = function onGetOrderHistory(event) {
	  event.preventDefault();
	  // console.log("this is get order history");
	  api.getOrderHistory().done(ui.getOrderSuccess);
	  // .fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getOrderSuccess = function getOrderSuccess(data) {
	  ...
	  if (app.orders.length !== 0) {
	    ...
	    var orderHistory = "<table> <tr> <th> Total Cost ($) </th> <th> Item </th> <th> Quantity </th> </tr>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateProfile = function onCreateProfile(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createProfile(data).done(ui.success).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cart = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var adminApi = __webpack_require__(46);
	var adminUi = __webpack_require__(47);
	var app = __webpack_require__(6);
	...
	var onAdminSignIn = function onAdminSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  console.log(data);
	  adminApi.adminSignIn(data).done(adminUi.signInSuccess).fail(adminUi.signInFail);
	};

	var onAdminSignOut = function onAdminSignOut(event) {
	  event.preventDefault();
	  adminApi.adminSignOut().done(adminUi.signOutSuccess).fail(adminUi.failure);
	};

	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  adminApi.changePassword(data).done(adminUi.success).fail(adminUi.failure);
	};
	...
	var onCreateProduct = function onCreateProduct(event) {
	  ...
	  return $.ajax({
	    ...
	    contentType: false,
	    processData: false
	  }).done(adminUi.createProductSuccess).fail(adminUi.failure);
	};

	var loadAll = function loadAll() {
	  $('#create-product').hide();
	  $('#admin-display-all').show();
	  adminApi.getAllProducts().done(adminUi.getAllProductsSuccess).fail(adminUi.failure);
	};
	...
	var onUpdateProduct = function onUpdateProduct(event) {
	  ...
	  var data = getFormFields(event.target);
	  console.log(data);
	  var product_id = $('#update-product-id').val();
	  console.log(product_id);

	  adminApi.updateProduct(data, product_id).done(adminUi.updateProductSuccess).fail(adminUi.failure);
	};
	...
	var onDeleteProduct = function onDeleteProduct(event) {
	  ...
	  adminApi.deleteProduct(product_id).done(adminUi.deleteProductSuccess).fail(adminUi.failure);
	};

	var onCreateProductButton = function onCreateProductButton(event) {
	  event.preventDefault();
	...
	var onAdminModal = function onAdminModal(event) {
	  event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var adminSignIn = function adminSignIn(data) {
	  return $.ajax({
	...
	var adminSignOut = function adminSignOut() {
	  return $.ajax({
	...
	var updateProduct = function updateProduct(data, product_id) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reload = function reload() {
	  $('#create-product').hide();
	  $('#admin-display-all').show();
	  adminApi.getAllProducts().done(getAllProductsSuccess).fail(failure);
	};
	...
	var productDetails = function productDetails(event) {
	...
	var getAllProductsSuccess = function getAllProductsSuccess(data) {
	  ...
	  for (var i = 0; i < data.products.length; i++) {
	    $('#admin-display-all').append("<div id='admin_product" + data.products[i]._id + "' " + "data-id='" + data.products[i]._id + "' " + "data-price='" + data.products[i].price + "' " + "data-description='" + data.products[i].description + "' " + "data-category='" + data.products[i].category + "' " + "data-image='" + data.products[i].image + "' " + "data-name='" + data.products[i].name + "' " + "class='admin-product' " + "value='" + data.products[i]._id + "'>" + "<img class='admin-product-image' src=" + data.products[i].image + ">" + "<p>" + data.products[i].name + "</p>" + "<p>" + data.products[i].category + "</p>" + "<p>$" + data.products[i].price + "</p>" + "<p>" + data.products[i].description + "</p>" + "</div>");
	...
	var deleteProductSuccess = function deleteProductSuccess(data) {
	  $('#admin-product-modal').modal('hide');
	  reload();
	};
