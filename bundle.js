...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"row\" id=\""
	    ...
	    + "</p>\n      </div>\n      <div class=\"col-md-3 cart\">\n        <button class=\"x\" size=\"small\">x</button>\n      </div><br>\n    </div>\n    <form>\n      <fieldset>\n        <input type=\"text\" name=\"order[items][product_id]\" value=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n        <input type=\"number\" name=\"order[items][price]\" value="
	    + alias4(((helper = (helper = helpers.price || (depth0 != null ? depth0.price : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"price","hash":{},"data":data}) : helper)))
	    + ">\n        <input type=\"text\" name=\"order[items][name]\" value=\""
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "\">\n        <input type=\"number\" name=\"order[items][quantity]\" value="
	    + alias4(((helper = (helper = helpers.quantity || (depth0 != null ? depth0.quantity : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"quantity","hash":{},"data":data}) : helper)))
	    + ">\n      </fieldset>\n    </form>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onAdminSignIn = function onAdminSignIn(event) {
	  ...
	  var data = getFormFields(event.target);
	  console.log(data);
	  adminApi.adminSignIn(data).done(adminUi.signInSuccess).fail(adminUi.failure);
	};
